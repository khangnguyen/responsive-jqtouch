...
(function() {
    ...
    jQTouchCore = function(options) {
        ...
        var $ = options.framework,
		    ...
		    {name:'none', selector:'.no-animation'},
        ...
        function getAnimation(el) {
            ...
            if (!animation) {
              var $cs = $("div.current").find(".content-secondary");
              var $cp = $("div.current").find(".content-primary");
	      if ($cs.is(':visible') && $cp.is(':visible')) {
            ...
            if (href != '#') {
                $.ajax({
                    ...
                    success: function (data) {
                        //Only do this when primary content is visible
